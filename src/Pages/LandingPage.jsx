...
import { CheckCircle2, ArrowRight, Grid3X3, Users, BarChart3, Play } from "lucide-react";
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-24 w-80 h-80 bg-purple-100 rounded-full mix-blend-multiply blur-3xl opacity-60 animate-pulse" style={{ animationDelay: "1.2s" }} />
        <div className="absolute top-1/3 left-1/5 w-64 h-64 bg-green-100 rounded-full mix-blend-multiply blur-3xl opacity-60 animate-pulse" style={{ animationDelay: "2.4s" }} />
      </div>
      ...
      >
        ...
        <div className="hidden items-center gap-6 md:flex">
          <a className="text-sm font-medium text-gray-700 transition hover:text-gray-900" href="#features">Features</a>
          <a className="text-sm font-medium text-gray-700 transition hover:text-gray-900" href="#pricing">Pricing</a>
          <a className="text-sm font-medium text-gray-700 transition hover:text-gray-900" href="#faq">FAQ</a>
        ...
        >
          ...
          <motion.div variants={item} className="space-y-7">
            ...
            <h1 className="text-5xl font-extrabold leading-tight text-gray-900 md:text-6xl">
              Organize. Focus. <span className="bg-gradient-to-r from-purple-200 to-blue-200 bg-clip-text text-transparent">Finish.</span>
            </h1>
            <p className="text-lg leading-relaxed text-gray-600">
              A refined workspace for todos and projects. Gentle visuals, zero clutter, and just enough data to keep momentum.
            </p>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <span className="text-sm text-gray-600">Pastel-first, distraction-free UI</span>
            </div>
          </motion.div>
...
>
                ...
                <div className="mt-4 space-y-3">
                  <div className="rounded-xl bg-yellow-100 p-3">
                    <div className="mb-2 flex items-center justify-between text-xs font-medium text-gray-700">
                      <span>Website Redesign</span><span>75%</span>
                    </div>
                    <div className="h-2 w-full rounded-full bg-yellow-200">
                      <div className="h-2 rounded-full bg-yellow-200" style={{ width: "75%" }} />
                    </div>
                  </div>
                  <div className="rounded-xl bg-purple-100 p-3">
                    ...
                    <div className="h-2 w-full rounded-full bg-purple-200">
                      <div className="h-2 rounded-full bg-purple-200" style={{ width: "60%" }} />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-4 flex justify-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white/80 p-2 shadow-sm backdrop-blur">
                <AnimatePresence mode="popLayout">
                  ...
                  >
                    <div className={`flex h-8 w-8 items-center justify-center rounded-lg ${features[featureIdx].bg}`}>
                      {React.createElement(features[featureIdx].icon, { className: "h-4 w-4 text-gray-700" })}
                    </div>
                    <div className="pr-1 text-sm">
                      <p className="font-semibold text-gray-900">{features[featureIdx].title}</p>
                      <p className="-mt-0.5 text-gray-600">{features[featureIdx].desc}</p>
                    </div>
                  </motion.div>
                </AnimatePresence>
              </div>
      ...
      <section id="features" className="relative z-10 mx-auto max-w-7xl px-6 pb-16">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {[
            { Icon: Grid3X3, title: "Structure that feels natural", desc: "Projects, lists and priorities without ceremony.", bg: "bg-blue-100" },
            { Icon: BarChart3, title: "Progress without pressure", desc: "Lightweight charts and activity cues.", bg: "bg-yellow-100" },
{ Icon: CheckCircle2, title: "Stay on top of tasks", desc: "Clear priorities and calm reminders keep you focused.", bg: "bg-pink-100" }
            ...
            <motion.div
              ...
              className={`rounded-2xl ${bg} p-6 shadow-sm`}
            >
      ...
      <section className="relative z-10 px-6 pb-20">
        <div className="mx-auto max-w-4xl overflow-hidden rounded-3xl border border-gray-200 bg-gradient-to-r from-green-100 to-blue-100 p-8 shadow-xl">
          <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Ready to move from list to done?</h2>
              <p className="mt-1 text-gray-700">Sign in to keep your momentum. It takes seconds.</p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row">
              <a href="#login" className="inline-flex items-center justify-center rounded-xl border border-blue-200 bg-white px-6 py-3 font-semibold text-gray-900 shadow-sm transition hover:bg-blue-100">
                Sign in
              </a>
              <a href="#demo" className="inline-flex items-center justify-center rounded-xl border border-purple-200 bg-white px-6 py-3 font-semibold text-gray-900 shadow-sm transition hover:bg-purple-100">
                Watch demo
